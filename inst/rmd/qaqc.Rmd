...
This is an auto-generated report assessing the compatibility of the `r params$title` data set with the AAE database. The submitted file includes `r nrow(data)` rows of data.
...
if (!is.null(spp)) {
  colnames(spp)[1:4] <- c("Input species", "VBA scientific name", "VBA common name", "Possible matches")
  print(kable(
    spp,
